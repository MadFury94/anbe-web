            ...
            <div className="container">
                <div className="footer-grid">
                    ...
                    <div className="footer-col"><h5>Services</h5>
                        <a href="/services" className="active">Pipeline Construction</a><a href="/services" className="active">Flare Systems</a>
                        <a href="/services" className="active">Fabrication</a><a href="/services" className="active">Procurement</a>
                    </div>
                    <div className="footer-col"><h5>Industries</h5>
                        <a href="/services" className="active">Oil &amp; Gas</a><a href="/services" className="active">Infrastructure</a>
                        <a href="/services" className="active">Manufacturing</a><a href="/services" className="active">Government</a>
                    </div>
